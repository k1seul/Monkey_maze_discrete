...
agent_train(uniform_sample=True, TD_sample=True, game_version=game_ver, agent_memory_based=False)
agent_train(uniform_sample=True, TD_sample=True, game_version=game_ver, agent_memory_based=True)
