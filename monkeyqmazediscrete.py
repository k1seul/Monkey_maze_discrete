...
class MonkeyQmazeDiscrete(gym.Env):
    """
    ...
    def __init__(self, render_mode = None, memory_state_size = None, backstep_lock = True):
        ...
        self.action_n = 4 - int(backstep_lock)
    ...
    def step(self, action):
        ...
        if action == 1:
            ...
            self._agent_head_direction = (self._agent_head_direction + 1) % 4 
        elif action == 2:
            head_turned = True 
            new_location = self._agent_location
            self._agent_head_direction = (self._agent_head_direction - 1) % 4 
        elif action == 0: 
            direction = self._head_to_direction[self._agent_head_direction]
